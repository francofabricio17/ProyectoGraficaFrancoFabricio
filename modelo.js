...
function init() {
   ...
   manager.onLoad = function () {
    ...
    // OPTIMIZACIÓN 1: Limitar el PixelRatio a 1
    renderer.setPixelRatio(1); 
    renderer.toneMapping = THREE.ACESFilmicToneMapping;
    renderer.toneMappingExposure = 1.0; 
    renderer.outputColorSpace = THREE.SRGBColorSpace; 
    
    // OPTIMIZACIÓN 2: Desactivar sombras
    renderer.shadowMap.enabled = false;
    // renderer.shadowMap.type = THREE.PCFSoftShadowMap; // Comentado
    ...
    directionalLight.castShadow = false; // Sombras desactivadas
    
    // OPTIMIZACIÓN 3: Bajar resolución del mapa de sombras (por si luego las activas)
    ...
    cargar.load("assets/piso.glb", function(gltf) {
        ...
        plaza.traverse(function(obj) {
            if(obj.isMesh) {
                obj.castShadow = false; // Sombras desactivadas
                obj.receiveShadow = false; // Sombras desactivadas
                if(obj.material) {
                    ...
                    if(obj.material.map) {
                        ...
                        // OPTIMIZACIÓN 4: Desactivar filtro anisotrópico
